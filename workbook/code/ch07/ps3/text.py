# Define line data for each character in Hershey Simplex style
simplex_data = {
    'A': [((0, 0), (2.5, 10)), ((2.5, 10), (5, 0)), ((1, 5), (4, 5))],
    'B': [((0, 0), (0, 10)), ((0, 10), (3, 10)), ((3, 10), (4, 9)), ((4, 9), (4, 6)), 
          ((4, 6), (3, 5)), ((3, 5), (4, 4)), ((4, 4), (4, 1)), ((4, 1), (3, 0)), 
          ((3, 0), (0, 0)), ((0, 5), (3, 5))],
    'C': [((5, 0), (1, 0)), ((1, 0), (0, 1)), ((0, 1), (0, 9)), ((0, 9), (1, 10)), ((1, 10), (5, 10))],
    'D': [((0, 0), (0, 10)), ((0, 10), (3, 10)), ((3, 10), (4, 9)), ((4, 9), (4, 1)), ((4, 1), (3, 0)), ((0, 0), (3, 0))],
    ...
    'P': [((0, 0), (0, 10)), ((0, 10), (4, 10)), ((4, 10), (5, 9)), ((5, 9), (5, 6)), ((5, 6), (4, 5)), ((4, 5), (0, 5))],
    'Q': [((0, 0), (5, 0)), ((5, 0), (5, 10)), ((5, 10), (0, 10)), ((0, 10), (0, 0)), ((3, 3), (5, 0))],
    'R': [((0, 0), (0, 10)), ((0, 10), (4, 10)), ((4, 10), (5, 9)), ((5, 9), (5, 6)), ((5, 6), (4, 5)), ((4, 5), (0, 5)), ((0, 5), (5, 0))],
    'S': [((5, 10), (1, 10)), ((1, 10), (0, 9)), ((0, 9), (1, 5)), ((1, 5), (4, 5)), 
          ((4, 5), (5, 1)), ((5, 1), (4, 0)), ((4, 0), (0, 0))],
    'T': [((2.5, 0), (2.5, 10)), ((0, 10), (5, 10))],
    'U': [((0, 10), (0, 1)), ((0, 1), (1, 0)), ((1, 0), (4, 0)), ((4, 0), (5, 1)), ((5, 1), (5, 10))],
...
scale = 2                  # Scale for the font size
...
print("PPM image 'output.ppm' created with the alphabet.")