...
class IfNode(ASTNode):
    ...
    def to_dict(self):
        return {"type": "If", "cond": self.condition.to_dict(), "then": self.then_statement.to_dict()}
...
class WhileNode(ASTNode):
    ...
    def to_dict(self):
        return {"type": "While", "cond": self.condition.to_dict(), "body": self.body.to_dict()}
    ...
    def compile_file(input_filename: str, output_filename: str = None):
        ...
        try:
            ...
            with open(token_file, "w") as f:
                json.dump(lexer.tokens, f, indent=2)
            ...
            print(f"Compiled {input_filename}")
            print(f"  Tokens → {token_file}")
            print(f"  AST    → {ast_file}")
            print(f"  C code → {output_filename}")
