...
| Classic Examples | MergeSort, QuickSort, Binary Search, Strassen Matrix Mul, Closest Pair of Points | 0/1 Knapsack, Fibonacci, Longest Common Subsequence, Matrix Chain Multiplication, Edit Distance, Coin Change, Egg Dropping (optimised) |
