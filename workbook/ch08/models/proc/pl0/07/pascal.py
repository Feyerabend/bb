...
class PL0Interpreter:
    ...
    def run(self):
        ...
        while self.p < len(self.code):
            ...
            if i.op == Operation.LIT:
                ...
                if i.a == 0:  # Return
                    ...
                    if i.a in [1, 6]:
                        ...
                        elif i.a == 6:  # Check odd
                            self.s[self.t] = int(self.s[self.t] % 2 != 0)
                        ...
                        if i.a == 2:  # Addition
                            ...
                            self.s[self.t] = int(left < right)
                        elif i.a == 11:  # Greater than or equal
                            self.s[self.t] = int(left >= right)
                        elif i.a == 12:  # Greater than
                            self.s[self.t] = int(left > right)
                        elif i.a == 13:  # Less than or equal
                            self.s[self.t] = int(left <= right)
            ...
            elif i.op == Operation.CAL: # correct?
                new_bp = self.t + 1
