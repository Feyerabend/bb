...
- *What*: Files are basic units for storing arbitrary data (text, images, executables).
  Databases are organised collections of data, often optimized for efficient access,
...
- *How*: At a hardware level, storage devices (e.g., HDDs, SSDs, SD cards) divide space
  ...
  systems (DBMS) handle organization, allocation, and access.
- *Key Principles*:
  ...
  - *Organization*: Uses indexes, tables, or trees to track locations. Fragmentation
