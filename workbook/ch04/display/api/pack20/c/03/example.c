...
void on_button_a(button_t button) {
    ...
    if ((result = led_set_rgb(255, 0, 0)) != DISPLAY_OK) {
        printf("Error setting LED: %s\n", display_error_string(result));
    }
}
...
void on_button_b(button_t button) {
    ...
    if ((result = led_set_rgb(0, 255, 0)) != DISPLAY_OK) {
        printf("Error setting LED: %s\n", display_error_string(result));
    }
}
...
void on_button_x(button_t button) {
    ...
    if ((result = led_set_rgb(0, 0, 255)) != DISPLAY_OK) {
        printf("Error setting LED: %s\n", display_error_string(result));
    }
}
...
void on_button_y(button_t button) {
    ...
    if ((result = led_set_rgb(255, 255, 0)) != DISPLAY_OK) {
        printf("Error setting LED: %s\n", display_error_string(result));
    }
}
...
static bool draw_initial_screen(void) {
    ...
    const char* test_lines[] = {
        ...
        "0123456789012345678901234567890123456789", // ? works
...
static bool initialize_system(void) {
    ...
    if ((result = display_init()) != DISPLAY_OK) {
        printf("Failed to initialise display: %s\n", display_error_string(result));
        return false;
    }
    printf("Display initialised successfully\n");
    
    // Init LED with error checking
    if ((result = led_init()) != DISPLAY_OK) {
        printf("Failed to initialise LED: %s\n", display_error_string(result));
        return false;
    }
    printf("LED initialised successfully\n");
