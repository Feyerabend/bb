...
<<<<<<< HEAD:workbook/ch04/projects/images/micropython/image_client.py
        print("\nDEBUG: Waiting for connection...")
        print("LED: Blinking = Connecting, Steady = Connected\n")
=======
        print("\nDEBUG: Waiting for connection..")
>>>>>>> 4be9a8a2e0d27343dae650bffcbeb595ef143361:workbook/ch04/projects/files/old/image_client.py
