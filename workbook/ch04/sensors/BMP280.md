...
Good — then let’s go all in and do temperature + pressure + humidity for the BME280, still without external libraries.

Read calibration constants (there are quite a few, from addresses 0x88–0xA1 and 0xE1–0xE7).

Read raw data (0xF7–0xFE).

Apply compensation formulas (straight from the Bosch datasheet).
